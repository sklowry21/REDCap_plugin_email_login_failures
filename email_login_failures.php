 ...
 * DESCRIPTION: This reports on login failures for people with too many failures in xx hours
 * VERSION:     1.0
...
$r = mySendEmail($send_to, $send_from, $debugLog, "REDCap login failures",
...
function mySendEmail($to, $from, $debugLog, $subject, $body, $cc, $bcc) {
    if ($debugLog) LogWrite( "to: $to, from: $from, cc: $cc");
